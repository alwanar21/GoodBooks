                    ...
                    <div className="max-w-7xl mx-auto px-[16px] py-[24px] sm:px-[60px] sm:py-[18px] md:px-[80px]">
                        ...
                        <div className="flex flex-col md:flex-row gap-6 md:gap-12 ">
                            <div className="flex flex-col gap-6 items-center md:w-1/4 ">
                                ...
                                <Link to={data.link} target='_blank' className="text-white  text-center font-medium text-sm bg-[#409D69] py-1 w-64 md:w-full hover:bg-[#2D7C50] duration-300">Link Pembelian</Link>
                            </div>
