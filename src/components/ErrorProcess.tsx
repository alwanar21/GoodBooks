...
export default function ErrorProcess() {
    return (
        <section className="py-4 bg-neutral-50 overflow-hidden min-h-[300px] pt-[130px]">
            <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
                <div className="max-w-md text-center flex flex-col items-center justify-center">
                    ...
                    <p className="text-2xl font-semibold md:text-3xl">Maaf, terdapat kesalahan dalam mengambil data dari server. </p>
                    <p className="mt-4 mb-8 text-xl dark:text-gray-400">Silakan coba lagi nanti.</p>
                </div>
            </div>
        </section>
    )
